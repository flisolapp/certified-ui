...
import { SearchResultDownloadCertificateDialog } from './search-result-download-certificate-dialog/search-result-download-certificate-dialog';
...
export class SearchResultCard {
  ...
  public async doDownload(item: CertificateElement): Promise<void> {
    const dialogRef: MatDialogRef<SearchResultDownloadCertificateDialog> = this.dialog.open(
